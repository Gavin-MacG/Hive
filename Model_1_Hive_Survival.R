...
# HIVE2017MTL <- HIVE %>% filter(Year == "2017" & City == "MTL")
# HIVE2017TO <- HIVE %>% filter(Year == "2017" & City == "TO")
################################################################################
#                                Variable creation
################################################################################
...
# HIVEOG <- HIVE
# HIVE <- filter(HIVEOG,City == "MTL")
# HIVE <- filter(HIVEOG,City == "TO")
